...
cssclasses:
  - hide_properties
created: 2025.05.09 09:01:53.000 -0700
updated: 2025.05.09 09:24:00.003 -0700
banner: "[[whole-wheat-soft-and-hearty-bread.jpg]]"
---
...
- *Makes delicious toast and sandwiches*
- *Easy to make ahead or freeze*
- *8 simple ingredients*

![[whole-wheat-sandwich-bread.jpg|500]]

## Ingredients

### Sponge

- [ ] 1 cup (240ml) water, warmed to about 110 °F (ca. 43 °C)
- [ ] 1/3 cup (80ml) whole milk, warmed to about 110 °F (ca. 43 °C)
- [ ] 2 and 1/4 teaspoons (7g) active dry or instant yeast (1 standard packet)
- [ ] 2 cups (260g) whole wheat flour ([[How to Properly Measure Baking Ingredients|spooned & levelled]])
...
7. **2nd rise:** Cover shaped loaf. Allow to rise until it’s about 1 inch (2.54 cm) above the top of the loaf pan, about 45–60 minutes.
8. Adjust oven rack to a lower position and preheat oven to 350 °F (ca. 177 degree Celsius). It’s best to bake the bread towards the bottom of the oven, so the top doesn’t burn.
...
3. **Milk:** Low-fat or nondairy milk work here, but whole milk produces phenomenal texture and I highly recommend it. 
4. **Yeast:** I usually use instant yeast. You can use active dry yeast instead, with no changes to the preparation. Rise times will be slightly longer. Reference my [[Baking with Yeast Guide]] for answers to common yeast FAQs.
5. **Flour:** Make sure your whole-wheat flour is fresh. Check the date on the package, and don’t store it uncovered. Whole-wheat flour can become rancid if stored for too long, and your bread will taste bitter. You can use **all** whole-wheat flour in this recipe, or substitute 1 cup (130g) of bread flour for a slightly taller, fluffier loaf. You can use 1 cup of bread flour in the sponge in step 1 OR save it for the remaining dough in step 2. If using 1 cup (130g) of bread flour in step 2, you’ll also need the 1/3 cup (43g) of whole wheat flour.
6. **Honey:** Honey produced the best tasting bread. In a pinch, you can use regular granulated sugar or brown sugar. But you will miss out on that honey flavour. I have not tested other sweeteners.
7. **Can I shape this into a round boule?** No, this dough requires the structure of a loaf pan.
8. **Doubling this recipe:** For best results, I recommend making two separate batches of dough. This is a big, heavy dough and the sponge will take a very long time to rise, and so will the kneading step. It’s best to make 2 separate doughs.
...
4. **Use an** [instant-read thermometer](https://amzn.to/3mL6unM) to check the internal temperature of the baked bread. This guarantees you won’t under-bake or over-bake the bread. It’s an incredibly helpful baking tool! The bread is done when the centre of the loaf is 195–200 °F (90–93 °C).
